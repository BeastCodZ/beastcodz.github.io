...
const projectsData = [
  {
    title: "Streamdecky",
    description:
      "A scalable web-based tool, enabling users to create and manage over 20 customizable buttons which can be executed over the network.",
  ...
  },
  {
    title: "BeastLock",
    description:
      "An advanced security system with built-in passkey authentication and a seamless UI, ensuring privacy and security for digital assets.",
    technologies: ["Electron", "MongoDB", "Node.js"],
    link: "https://github.com/BeastCodZ/beastlock/",
    image:
      "https://wallpapers.com/images/hd/cyber-security-codes-and-padlocks-louj44tbnhinx0e4.jpg",
    status: "in development",
  },
  {
    title: "WinKey",
    description:
      "A lightweight, Electron-based authenticator that streamlines Windows login and multi-factor authentication for developers and power users.",
    technologies: ["Electron", "Node.js"],
    link: "https://github.com/BeastCodZ/winkey/",
    image:
      "https://i.pinimg.com/736x/c5/99/22/c599223b857cb28289e80a1fbbfc2330.jpg",
    status: "in development",
  },
  {
    title: "Real-Time Whiteboard",
    description:
      "A collaborative, real-time whiteboard tool designed for teams, featuring kanban boards and advanced analytics integration.",
  ...
  },
  {
    title: "TaskerPro",
    description:
      "A task management system equipped with time tracking, Kanban boards, and detailed project analytics for optimized productivity.",
    ...
    >
      ...
      <div className="flex justify-between mt-8 w-full max-w-6xl">
        ...
        <motion.button
          ...
          className={`flex justify-center items-center w-12 h-12 bg-zinc-600 ${
            currentIndex + projectsPerPage >= projectsData.length
              ? "opacity-0 cursor-not-allowed"
              : "hover:bg-zinc-800"
          } rounded-full`}
