  ...
  return (
    <nav className='fixed top-0 left-0 w-full z-50 bg-transparent py-4 px-8'>
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <Image 
  src="/owl.png" 
  className="h-16" // Use 'w-auto' for responsive width
  alt="BeastCodZ Logo" 
  width={64} // You can leave this out or set a max width if needed
  height={64} // Set the height to maintain aspect ratio
/>
        ...
        {/* <div className={`md:block ${isOpen ? 'block' : 'hidden'} w-full md:w-auto`} id="navbar-default">
          <ul className={`font-medium flex flex-col p-4 md:p-0 mt-4 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 dark:border-gray-700 
            ${isOpen ? 'bg-gray-800' : ''} md:bg-transparent`}>
            <li>
