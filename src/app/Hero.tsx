    ...
    <>
      <section className="h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center text-white px-4 md:px-8">
          <h1
            className={`${quantico.className} text-5xl md:text-7xl font-bold mb-4`}
          >
            BeastCodZ
          </h1>
          <p
            className={`${noto.className} text-2xl md:text-3xl font-light mb-8`}
          >
            Full Stack Developer
          </p>
          <p
            className={`${noto.className} text-lg md:text-xl max-w-2xl mx-auto mb-12`}
          >
            Building intelligent, scalable solutions that fuse creativity with
            code. Pushing the boundaries of full-stack development, one line at
            a time.
          </p>
          <motion.button
