  ...
  return (
    <div className="bg-[#146d5b07] text-[#00FFCC] p-4 sm:p-6 md:p-10 rounded-2xl shadow-lg backdrop-blur-sm transition-all duration-300 ease-in-out max-w-4xl mx-auto z-1">
      ...
      <div className="mb-8 flex flex-col items-start gap-4">
        ...
        <div>
          <h3 className="text-lg font-semibold">&gt; cat → <span className="text-[#FF4444]">skills.txt</span></h3>
          <p className="text-sm mt-1 text-pretty">
            Polished through trial, not tutorials. Every skill here has been battlefield-tested.
          </p>
        </div>
      </div>
        ...
        <div>
          ...
          <p className="text-sm">
            ...
            <span className="relative group cursor-pointer">
              <span className="text-[#FF4444]">FallenOS</span>
              <span className="absolute left-1/2 -translate-x-1/2 mt-1 px-2 py-2 rounded bg-[#222222b0] text-[#FF4444] text-xs opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10 whitespace-nowrap">
                Custom Arch Linux Distro
              </span>
            </span>
          </p>
          <p className="text-xs mt-2 text-[#00ffccaa] italic">
