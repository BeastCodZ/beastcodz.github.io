    ...
    >
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        >
          ...
          <div className="flex flex-wrap gap-2">
            {[
              { name: "JavaScript", icon: <Javascript width={16} height={16} /> },
              { name: "Node.js", icon: <Nodedotjs width={16} height={16} /> },
              { name: "Express.js", icon: <SiExpress width={16} height={16} /> },
              { name: "React", icon: <React width={16} height={16} /> },
              { name: "Next.js", icon: <SiNextdotjs width={16} height={16} /> },
              { name: "TypeScript", icon: <Typescript width={16} height={16} /> },
              { name: "TailwindCSS", icon: <SiTailwindcss width={16} height={16} /> },
        ...
        >
          ...
          <div className="flex flex-wrap gap-2">
            {[
              ...
              { name: "Arch Linux", icon: <ArchLinux width={16} height={16} /> },
        ...
        >
          ...
          <div className="flex flex-wrap gap-2">
            {[
              ...
              { name: "PostgreSQL", icon: <SiPostgresql width={16} height={16} /> },
            ].map((skill) => (
              <span key={skill.name} className={chipClassName}>
                {skill.icon}
                {skill.name}
      ...
      >
        ...
        <div className="flex flex-wrap gap-2">
          {[
            ...
            { name: "Premiere Pro", icon: <Premierepro width={16} height={16} /> },
            { name: "After Effects", icon: <AfterEffects width={16} height={16} /> },
          ].map((skill) => (
            <span
              key={skill.name}
              className="
