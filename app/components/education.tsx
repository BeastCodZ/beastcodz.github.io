  ...
  return (
    ...
    >
        ...
        >
          <div className="flex items-start gap-4">
            <Image
              ...
              width={48}
              height={48}
              className="rounded-lg shrink-0 bg-(--accent)"
            />
            ...
            <div>
              ...
              <p className="text-xs text-(--text-muted)">2025 – 2029</p>
            </div>
          </div>
          <div
            className="
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-(--text-muted)">2022 – 2024</p>
            </div>
          </div>
      ...
      >
        ...
        <span>
          The fundamentals learned here continue to shape every project built
          today.
        </span>
      </div>
    </section>
