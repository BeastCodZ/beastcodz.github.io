      ...
      <div className="mb-8 flex flex-col items-start gap-4">
        ...
        <div className="flex-1 ">
          ...
          <p className="text-sm sm:text-base mt-2 text-pretty">
            I’m a <span className="text-[#FF4444]">developer</span> with
            curiosity for how things work — and how to break them. Whether I’m
            crafting tools for myself, tweaking my OS, or building something out
            of boredom, I stay <span className="text-[#FF4444]">ready()</span>{" "}
            by staying hands-on.
          </p>

          <p className="text-sm sm:text-base mt-2 text-pretty">
            Right now, I’m polishing my academics while keeping my coding
            fundamentals sharp before university kicks off. I believe software
            should always evolve — just like its developer.
          </p>

          <p className="text-sm sm:text-base mt-2 text-pretty">
            I type like I mean it. And yeah, I use{" "}
            <span className="text-[#FF4444]">Arch</span>, btw.
          </p>

          <p className="text-xs mt-3 text-[#00ffccaa] italic text-pretty">
            &ldquo;Why read the manual, when you can rewrite the whole thing
            your way?&rdquo;
          </p>
        </div>
      </div>
