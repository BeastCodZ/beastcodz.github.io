...
export function ScrollGallery() {
    ...
    <div className="relative w-full max-w-6xl mx-auto py-12">
      ...
      >
        {photos.map((photo, index) => {
          ...
          const isPortrait = photo.landscape === undefined ? true : !photo.landscape;
          ...
          return (
            <motion.div
              ...
              drag="x" // fallback if pointer fails
              ...
              style={{ touchAction: 'none' }} // ✨ this ensures touch works!
            >
              <div
  ...
  {isActive ? (
    <a href={`/photography/${photo.file}`} target="_blank" rel="noopener noreferrer">
      <Image
