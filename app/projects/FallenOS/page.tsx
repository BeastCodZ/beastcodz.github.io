  ...
  return (
    <div className="bg-[#146d5b07] text-[#00FFCC] p-6 md:p-10 rounded-2xl shadow-lg backdrop-blur-sm transition-all duration-300 ease-in-out max-w-4xl mx-auto z-1">
      ...
      <div className="mb-8 flex items-start gap-4">
        ...
        <div>
          <h3 className="text-lg font-semibold">&gt; project → <span className="text-[#FF4444]">FallenOS</span></h3>
          <p className="text-sm mt-1 text-[#00ffccaa] italic">
            “Built in the ruins of Arch.”
          </p>
        </div>
      </div>
      ...
      <div className="mb-8 space-y-4 text-sm">
        <p>
  FallenOS is my custom-built Arch Linux distro tailored for speed, aesthetics, and full keyboard-driven control. It features the Hyprland window manager, a custom theming layer, and preconfigured tools like Kitty, Fish — all optimized for minimal resource usage and maximum productivity. Designed for users who live in the terminal and thrive in chaos.
</p>
      ...
      <div className="mb-8 space-y-4">
        <div className="flex items-start gap-3">
          <Terminal size={20} />
          <span className="text-sm">Tiling window manager (Hyprland) | Terminal (Kitty + Fish)</span>
        </div>
        <div className="flex items-start gap-3">
          <Cog size={20} />
          <span className="text-sm">Optimized for smooth and quiet runtime.</span>
        </div>
        <div className="flex items-start gap-3">
          <Shield size={20} />
        ...
        <div className="mb-8">
            ...
            <div className="flex flex-wrap gap-2">
              <div className="relative">
                    <a href='/projects/FallenOS/2.png' target="_blank" rel="noopener noreferrer">
                    <img
                ...
                <div className="relative">
                    <a href='/projects/FallenOS/4.png' target="_blank" rel="noopener noreferrer">
                    <img
                ...
                <div className="relative">
                    <a href='/projects/FallenOS/3.png' target="_blank" rel="noopener noreferrer">
                    <img
              ...
              <div className="relative">
                ...
                <div className="relative">
                    <a href='/projects/FallenOS/5.png' target="_blank" rel="noopener noreferrer">
                    <img
                ...
                <div className="relative">
                    <a href='/projects/FallenOS/6.png' target="_blank" rel="noopener noreferrer">
                    <img
                ...
                <div className="relative">
                    <a href='/projects/FallenOS/7.png' target="_blank" rel="noopener noreferrer">
                    <img
